...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcColgroupJsx = __webpack_require__(157);

	var _srcColgroupJsx2 = _interopRequireDefault(_srcColgroupJsx);

	var table = _react2['default'].createElement(
	    'table',
	    null,
	    _react2['default'].createElement(_srcColgroupJsx2['default'], { cols: [120, 140, 200] }),
	...
	_react2['default'].render(table, document.getElementById('colgroup-example'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Colgroup = (function (_React$Component) {
	    ...
	    function Colgroup() {
	        ...
	        _get(Object.getPrototypeOf(Colgroup.prototype), 'constructor', this).apply(this, arguments);
	    }

	    _createClass(Colgroup, [{
	        key: 'render',
	        value: function render() {
	            var cols = this.props.cols.map(function (colWidth, index) {
	                return _react2['default'].createElement('col', { key: 'col' + index, style: { width: colWidth } });
	            });
	...
	Colgroup.propTypes = {
	     ...
	     * @type {Array.<Number>}
	     */
	    cols: _react.PropTypes.arrayOf(_react.PropTypes.number)
	};
